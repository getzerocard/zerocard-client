...
interface SpendingLimitToastProps {
  visible?: boolean;
  onDismiss?: () => void;
}
    ...
    <Animated.View
      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.title}>Spending limit set!</Text>
          <Text style={styles.message}>
            We've applied your new spending cap, go and conquer the world
          </Text>
        </View>
      </View>
    </Animated.View>
...
export default SpendingLimitToast;
